...
class Block(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        x = torch.cat([x, self.drop_path(self.attn(self.norm1(x), H, W))], dim=-1)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if model_name == "pvt_v2_b0":
            self.model = pvt_v2_b0(in_chans=64)
        elif model_name == "pvt_v2_b1":
            self.model = pvt_v2_b1(in_chans=64)
        elif model_name == "pvt_v2_b2":
            self.model = pvt_v2_b2(in_chans=64)
        elif model_name == "pvt_v2_b2_li":
            self.model = pvt_v2_b2_li(in_chans=64)
        elif model_name == "pvt_v2_b3":
            self.model = pvt_v2_b3(in_chans=64)
        elif model_name == "pvt_v2_b4":
            self.model = pvt_v2_b4(in_chans=64)
        elif model_name == "pvt_v2_b5":
            self.model = pvt_v2_b5(in_chans=64)
        else:
            return NameError
