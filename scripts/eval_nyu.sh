...
# CUDA_VISIBLE_DEVICES=0 python eval.py experiment=$EXP ckpt_path=$CKPT_PATH num_sample=non_uniform task_name=${NAME}_uniform_sample ++trainer.deterministic=True $5
